...
public class ServicioServlet extends HttpServlet {
    ...
    private Servicio obtenerServicio(HttpServletRequest request) {
        ...
        * Servicio, y el parámetro accion sea igual index. Este método se encargara de
        ...
        * Servicio , y el parámetro accion sea igual index. Este método se encargara de
        * enviar los datos de los servicios al jsp de index de Servicio
        *
        *  @param request en este parámetro vamos a recibir el request de la
        ...
        */
        ...
        private void doPostRequestCreate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
                ...
                /**
            * En este método obtiene por Id un Servicio desde la capa de acceso a datos el
            * Id se captura del request que se envio al servlet de Servicio
            *
            * @param request en este parámetro vamos a recibir el request de la
