...
public class ServicioServlet extends HttpServlet {
    ...
    private void doGetRequestIndex(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            HttpURLConnection con = Utilidad.obtenerConnecionWebAPI("Servicio/Buscar", "POST",request);
    ...
    private void doPostRequestCreate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Codigo agregar para consumir la Web API
            int result = 0;
            HttpURLConnection con = Utilidad.obtenerConnecionWebAPI("Servicio", "POST",request);
            con.setDoOutput(true);
            Gson gson = new Gson();
            Utilidad.asignarJSONWebAPI(con, gson.toJson(servicio));
            con.connect();
    ...
    private void requestObtenerPorId(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Codigo agregar para consumir la Web API
            HttpURLConnection con = Utilidad.obtenerConnecionWebAPI("Servicio/" + servicio.getId(), "GET",request);
            con.connect();
            int status = con.getResponseCode();
            Gson gson = new Gson();
    ...
    private void doPostRequestEdit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Codigo agregar para consumir la Web API
            int result = 0;
            HttpURLConnection con = Utilidad.obtenerConnecionWebAPI("Servicio/" + servicio.getId(), "PUT",request);
            con.setDoOutput(true);
            Gson gson = new Gson();
            Utilidad.asignarJSONWebAPI(con, gson.toJson(servicio));
            con.connect();
    ...
    private void doPostRequestDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Codigo agregar para consumir la Web API
            int result = 0;
            HttpURLConnection con = Utilidad.obtenerConnecionWebAPI("Servicio/" + servicio.getId(), "DELETE", request);
            con.connect();
            int status = con.getResponseCode();
            if (status == HttpURLConnection.HTTP_OK) {
                result = 1;
